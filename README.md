...
(SDM) con un conjunto de algoritmos de aprendizaje automático (*machine
...
2.  Busca una especie (debe ser a nivel de especie) en GBIF bien
    ...
    especie elegida no tenga todos sus registros concentrados en un
    pequeño cúmulo. No se trata de una especie que esté en todas partes,
    sino de una que tenga muchos registros bien distribuidos. Si notas
    que la especie sigue un patrón de alguna variable climática,
...
6.  **Finalmente, ve a RStudio, clona el repo y redacta un manuscrito**.
    ...
    enlace de la PD04 y acepta la asignación. Deberás usar estilos de
